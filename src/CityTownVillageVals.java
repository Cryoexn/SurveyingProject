public interface CityTownVillageVals {
    ...
    public static final String AUGUSTA      = "Augusta";
    public static final String AVA          = "Ava";
    public static final String BOONVILLE    = "Boonville";
    public static final String BRIDGEWATER  = "Bridgewater";
    public static final String CAMDEN       = "Camden";
    public static final String DEERFIELD    = "Deerfield";
    public static final String FLORENCE     = "Florence";
    public static final String FLOYD        = "Floyd";
    public static final String FORESTPORT   = "Forestport";
    public static final String KIRKLAND     = "Kirkland";
    public static final String LEE          = "Lee";
    public static final String MARCY        = "Marcy";
    public static final String MARSHALL     = "Marshall";
    public static final String NEW_HARTFORD = "New Hartford";
    public static final String PARIS        = "Paris";
    public static final String REMSEN       = "Remsen";
    public static final String SANGERFIELD  = "Sangerfield";
    public static final String STEUBEN      = "Steuben";
    public static final String TRENTON      = "Trenton";
    public static final String VERNON       = "Vernon";
    ...
    public static final String WESTMORELAND = "Westmorland";
    public static final String WHITESTOWN   = "Whitestown";
