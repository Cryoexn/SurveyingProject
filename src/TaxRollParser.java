        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if(secBlkPcl.length > 2) {
                    ...
                    parcels.add(new TaxRollParcel(secBlkPcl[0], secBlkPcl[1], secBlkPcl[2], comps[1], comps[2], comps[3], comps[4], comps[6], comps[7]));
                } else {
                    parcels.add(new TaxRollParcel(secBlkPcl[0], secBlkPcl[1], null, comps[1], comps[2], comps[3], comps[4], comps[6], comps[7]));
                }
